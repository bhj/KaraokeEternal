...
export const ROOM_CLEAR_QUEUE = 'rooms/CLEAR_QUEUE'
...
export const SONG_INFO_SET_ROOM_PREFERRED = 'songInfo/SET_ROOM_PREFERRED'
export const SONG_INFO_SET_USER_PREFERRED = 'songInfo/SET_USER_PREFERRED'
